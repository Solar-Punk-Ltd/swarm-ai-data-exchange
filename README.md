...
| [`@solarpunk/catalogue-job`](packages/catalogue-job)                         | Background catalog indexing job.                                                                                                                                                                                                                                                                                      |
| [`@solarpunk/gsoc-data-event-processor`](packages/gsoc-data-event-processor) | GSoC (Global Swarm of Chunks) subscriber skeleton — connects to a Bee node, subscribes to a channel, hands each message to a placeholder handler.                                                                                                                                                                     |
